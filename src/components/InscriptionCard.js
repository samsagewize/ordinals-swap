          ...
          <>
            ...
            {showDetails && (
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px', marginTop: '8px' }}>
                ...
                {inscription.sat_rarity && inscription.sat_rarity !== 'common' && (
                  <span className="tag tag-orange">{inscription.sat_rarity}</span>
                )}
              </div>
            )}

            <a
              href={getInscriptionExplorerUrl(inscription.id)}
              target="_blank"
              rel="noreferrer"
